...
class MemoryClient:
    ...
    def getDOMCounters(
        ...
        return cast("GetDOMCountersReturns", self._client.send_raw(
            method="Memory.getDOMCounters",
            params=params,
            session_id=session_id,
        ))

    def getDOMCountersForLeakDetection(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "GetDOMCountersForLeakDetectionReturns":
        """Retruns DOM object counters after preparing renderer for leak detection."""
        return cast("GetDOMCountersForLeakDetectionReturns", self._client.send_raw(
            method="Memory.getDOMCountersForLeakDetection",
            params=params,
            session_id=session_id,
        ))

    def prepareForLeakDetection(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "Dict[str, Any]":
...
dropping non-essential internal caches, running garbage collections, etc."""
    ...
    def forciblyPurgeJavaScriptMemory(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "Dict[str, Any]":
    ...
    def simulatePressureNotification(
        self,
...
collected since renderer process startup."""
        return cast("GetAllTimeSamplingProfileReturns", self._client.send_raw(
            method="Memory.getAllTimeSamplingProfile",
            params=params,
            session_id=session_id,
        ))

    def getBrowserSamplingProfile(
        self,
        params: None = None,
        session_id: Optional[str] = None,
...
collected since browser process startup."""
        return cast("GetBrowserSamplingProfileReturns", self._client.send_raw(
