...
class BluetoothEmulationClient:
    ...
    def simulatePreconnectedPeripheral(
        self,
...
the central."""
    ...
    def simulateGATTOperationResponse(
        self,
...
Bluetooth Core Specification Vol 2 Part D 1.3 List Of Error Codes."""
    ...
    def simulateCharacteristicOperationResponse(
        self,
...
response."""
    ...
    def simulateDescriptorOperationResponse(
        self,
...
response."""
    ...
    def addService(
        ...
        return cast("AddServiceReturns", self._client.send_raw(
...
service represented by |serviceId|."""
        return cast("AddCharacteristicReturns", self._client.send_raw(
            method="BluetoothEmulation.addCharacteristic",
            params=params,
            session_id=session_id,
        ))

    def removeCharacteristic(
        self,
...
by |characteristicId|."""
        return cast("AddDescriptorReturns", self._client.send_raw(
