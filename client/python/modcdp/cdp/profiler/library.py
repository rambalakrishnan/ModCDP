...
garbage collection."""
        return cast("GetBestEffortCoverageReturns", self._client.send_raw(
            method="Profiler.getBestEffortCoverage",
            params=params,
            session_id=session_id,
        ))

    def setSamplingInterval(
        self,
...
counters."""
        return cast("StartPreciseCoverageReturns", self._client.send_raw(
    ...
    def stop(
        ...
        return cast("StopReturns", self._client.send_raw(
            method="Profiler.stop",
            params=params,
            session_id=session_id,
        ))

    def stopPreciseCoverage(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "Dict[str, Any]":
...
coverage needs to have started."""
        return cast("TakePreciseCoverageReturns", self._client.send_raw(
