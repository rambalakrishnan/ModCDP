...
class LayerTreeClient:
    ...
    def compositingReasons(
        ...
        return cast("CompositingReasonsReturns", self._client.send_raw(
    ...
    def loadSnapshot(
        ...
        return cast("LoadSnapshotReturns", self._client.send_raw(
    ...
    def makeSnapshot(
        ...
        return cast("MakeSnapshotReturns", self._client.send_raw(
    ...
    def profileSnapshot(
        ...
        return cast("ProfileSnapshotReturns", self._client.send_raw(
    ...
    def replaySnapshot(
        ...
        return cast("ReplaySnapshotReturns", self._client.send_raw(
            method="LayerTree.replaySnapshot",
            params=params,
            session_id=session_id,
        ))

    def snapshotCommandLog(
        self,
        params: "SnapshotCommandLogParameters",
        session_id: Optional[str] = None,
    ) -> "SnapshotCommandLogReturns":
        """Replays the layer snapshot and returns canvas log."""
        return cast("SnapshotCommandLogReturns", self._client.send_raw(
