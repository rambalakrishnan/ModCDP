...
class SystemInfoClient:
    ...
    def getInfo(
        ...
        return cast("GetInfoReturns", self._client.send_raw(
    ...
    def getFeatureState(
        ...
        return cast("GetFeatureStateReturns", self._client.send_raw(
    ...
    def getProcessInfo(
        ...
        return cast("GetProcessInfoReturns", self._client.send_raw(
