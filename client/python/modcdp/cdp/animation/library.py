...
class AnimationClient:
    ...
    def getCurrentTime(
        ...
        return cast("GetCurrentTimeReturns", self._client.send_raw(
    ...
    def getPlaybackRate(
        ...
        return cast("GetPlaybackRateReturns", self._client.send_raw(
            method="Animation.getPlaybackRate",
            params=params,
            session_id=session_id,
        ))

    def releaseAnimations(
        self,
    ...
    def resolveAnimation(
        ...
        return cast("ResolveAnimationReturns", self._client.send_raw(
