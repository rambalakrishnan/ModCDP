...
flag is set."""
        return cast("LoadUnpackedReturns", self._client.send_raw(
...
specified, these are used to filter the result."""
        return cast("GetStorageItemsReturns", self._client.send_raw(
            method="Extensions.getStorageItems",
            params=params,
            session_id=session_id,
        ))

    def removeStorageItems(
        self,
