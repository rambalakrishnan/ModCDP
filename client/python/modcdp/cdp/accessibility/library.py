...
This turns on accessibility for the page, which can impact performance until accessibility is disabled."""
    ...
    def getPartialAXTree(
        ...
        return cast("GetPartialAXTreeReturns", self._client.send_raw(
    ...
    def getFullAXTree(
        ...
        return cast("GetFullAXTreeReturns", self._client.send_raw(
...
Requires `enable()` to have been called previously."""
        return cast("GetRootAXNodeReturns", self._client.send_raw(
            method="Accessibility.getRootAXNode",
            params=params,
            session_id=session_id,
        ))

    def getAXNodeAndAncestors(
        self,
...
Requires `enable()` to have been called previously."""
        return cast("GetAXNodeAndAncestorsReturns", self._client.send_raw(
...
Requires `enable()` to have been called previously."""
        return cast("GetChildAXNodesReturns", self._client.send_raw(
...
`accessibleName` or `role` is specified, it returns all the accessibility nodes in the subtree."""
        return cast("QueryAXTreeReturns", self._client.send_raw(
