...
class NetworkClient:
    ...
    def clearAcceptedEncodingsOverride(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "Dict[str, Any]":
    ...
    def canClearBrowserCache(
        ...
        return cast("CanClearBrowserCacheReturns", self._client.send_raw(
            method="Network.canClearBrowserCache",
            params=params,
            session_id=session_id,
        ))

    def canClearBrowserCookies(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "CanClearBrowserCookiesReturns":
        """Tells whether clearing browser cookies is supported."""
        return cast("CanClearBrowserCookiesReturns", self._client.send_raw(
            method="Network.canClearBrowserCookies",
            params=params,
            session_id=session_id,
        ))

    def canEmulateNetworkConditions(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "CanEmulateNetworkConditionsReturns":
        """Tells whether emulation of network conditions is supported."""
        return cast("CanEmulateNetworkConditionsReturns", self._client.send_raw(
...
Deprecated. Use Storage.getCookies instead."""
        return cast("GetAllCookiesReturns", self._client.send_raw(
    ...
    def getCertificate(
        ...
        return cast("GetCertificateReturns", self._client.send_raw(
...
detailed cookie information in the `cookies` field."""
    ...
    def getResponseBody(
        ...
        return cast("GetResponseBodyReturns", self._client.send_raw(
            method="Network.getResponseBody",
            params=params,
            session_id=session_id,
        ))

    def getRequestPostData(
        self,
        params: "GetRequestPostDataParameters",
        session_id: Optional[str] = None,
    ) -> "GetRequestPostDataReturns":
        """Returns post data sent with the request. Returns an error when no data was sent with the request."""
        return cast("GetRequestPostDataReturns", self._client.send_raw(
    ...
    def getResponseBodyForInterception(
        ...
        return cast("GetResponseBodyForInterceptionReturns", self._client.send_raw(
...
is specified."""
        return cast("TakeResponseBodyForInterceptionAsStreamReturns", self._client.send_raw(
...
attribute, user, password."""
    ...
    def searchInResponseBody(
        ...
        return cast("SearchInResponseBodyReturns", self._client.send_raw(
    ...
    def setCookie(
        ...
        return cast("SetCookieReturns", self._client.send_raw(
...
If enabled, the dataReceived event contains the data that was received during streaming."""
        return cast("StreamResourceContentReturns", self._client.send_raw(
            method="Network.streamResourceContent",
            params=params,
            session_id=session_id,
        ))

    def getSecurityIsolationStatus(
        self,
        params: Optional["GetSecurityIsolationStatusParameters"] = None,
        session_id: Optional[str] = None,
    ) -> "GetSecurityIsolationStatusReturns":
        """Returns information about the COEP/COOP isolation status."""
        return cast("GetSecurityIsolationStatusReturns", self._client.send_raw(
            method="Network.getSecurityIsolationStatus",
            params=params,
            session_id=session_id,
        ))

    def enableReportingApi(
        self,
...
Enabling triggers 'reportingApiReportAdded' for all existing reports."""
    ...
    def loadNetworkResource(
        self,
        params: "LoadNetworkResourceParameters",
        session_id: Optional[str] = None,
    ) -> "LoadNetworkResourceReturns":
        """Fetches the resource and returns the content."""
        return cast("LoadNetworkResourceReturns", self._client.send_raw(
            method="Network.loadNetworkResource",
            params=params,
            session_id=session_id,
        ))

    def setCookieControls(
        self,
