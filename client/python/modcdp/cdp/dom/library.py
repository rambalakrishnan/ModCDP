...
class DOMClient:
    ...
    def collectClassNamesFromSubtree(
        ...
        return cast("CollectClassNamesFromSubtreeReturns", self._client.send_raw(
...
given anchor."""
        return cast("CopyToReturns", self._client.send_raw(
            method="DOM.copyTo",
            params=params,
            session_id=session_id,
        ))
...
objects, can be used for automation."""
        return cast("DescribeNodeReturns", self._client.send_raw(
...
be called for that search."""
    ...
    def getAttributes(
        ...
        return cast("GetAttributesReturns", self._client.send_raw(
    ...
    def getBoxModel(
        ...
        return cast("GetBoxModelReturns", self._client.send_raw(
...
might return multiple quads for inline nodes."""
        return cast("GetContentQuadsReturns", self._client.send_raw(
...
Implicitly enables the DOM domain events for the current target."""
        return cast("GetDocumentReturns", self._client.send_raw(
...
Use DOMSnapshot.captureSnapshot instead."""
        return cast("GetFlattenedDocumentReturns", self._client.send_raw(
            method="DOM.getFlattenedDocument",
            params=params,
            session_id=session_id,
        ))

    def getNodesForSubtreeByStyle(
        self,
        params: "GetNodesForSubtreeByStyleParameters",
        session_id: Optional[str] = None,
    ) -> "GetNodesForSubtreeByStyleReturns":
        """Finds nodes with a given computed style in a subtree."""
        return cast("GetNodesForSubtreeByStyleReturns", self._client.send_raw(
...
either returned or not."""
        return cast("GetNodeForLocationReturns", self._client.send_raw(
    ...
    def getOuterHTML(
        ...
        return cast("GetOuterHTMLReturns", self._client.send_raw(
            method="DOM.getOuterHTML",
            params=params,
            session_id=session_id,
        ))

    def getRelayoutBoundary(
        self,
        params: "GetRelayoutBoundaryParameters",
        session_id: Optional[str] = None,
    ) -> "GetRelayoutBoundaryReturns":
        """Returns the id of the nearest ancestor that is a relayout boundary."""
        return cast("GetRelayoutBoundaryReturns", self._client.send_raw(
...
identifier."""
        return cast("GetSearchResultsReturns", self._client.send_raw(
    ...
    def moveTo(
        ...
        return cast("MoveToReturns", self._client.send_raw(
            method="DOM.moveTo",
            params=params,
            session_id=session_id,
        ))
...
`cancelSearch` to end this search session."""
        return cast("PerformSearchReturns", self._client.send_raw(
            method="DOM.performSearch",
            params=params,
            session_id=session_id,
        ))

    def pushNodeByPathToFrontend(
        self,
        params: "PushNodeByPathToFrontendParameters",
        session_id: Optional[str] = None,
    ) -> "PushNodeByPathToFrontendReturns":
        """Requests that the node is sent to the caller given its path. // FIXME, use XPath"""
        return cast("PushNodeByPathToFrontendReturns", self._client.send_raw(
    ...
    def pushNodesByBackendIdsToFrontend(
        ...
        return cast("PushNodesByBackendIdsToFrontendReturns", self._client.send_raw(
    ...
    def querySelector(
        ...
        return cast("QuerySelectorReturns", self._client.send_raw(
    ...
    def querySelectorAll(
        ...
        return cast("QuerySelectorAllReturns", self._client.send_raw(
            method="DOM.querySelectorAll",
            params=params,
            session_id=session_id,
        ))

    def getTopLayerElements(
        self,
        params: None = None,
        session_id: Optional[str] = None,
...
appear on top of all other content."""
        return cast("GetTopLayerElementsReturns", self._client.send_raw(
            method="DOM.getTopLayerElements",
            params=params,
            session_id=session_id,
        ))

    def getElementByRelation(
        self,
        params: "GetElementByRelationParameters",
        session_id: Optional[str] = None,
    ) -> "GetElementByRelationReturns":
        """Returns the NodeId of the matched element according to certain relations."""
        return cast("GetElementByRelationReturns", self._client.send_raw(
...
`setChildNodes` notifications."""
        return cast("RequestNodeReturns", self._client.send_raw(
    ...
    def resolveNode(
        ...
        return cast("ResolveNodeReturns", self._client.send_raw(
...
attribute value and types in several attribute name/value pairs."""
    ...
    def getNodeStackTraces(
        self,
        params: "GetNodeStackTracesParameters",
        session_id: Optional[str] = None,
    ) -> "GetNodeStackTracesReturns":
        """Gets stack traces associated with a Node. As of now, only provides stack trace for Node creation."""
        return cast("GetNodeStackTracesReturns", self._client.send_raw(
...
File wrapper."""
        return cast("GetFileInfoReturns", self._client.send_raw(
            method="DOM.getFileInfo",
            params=params,
            session_id=session_id,
        ))

    def getDetachedDomNodes(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "GetDetachedDomNodesReturns":
        """Returns list of detached nodes"""
        return cast("GetDetachedDomNodesReturns", self._client.send_raw(
            method="DOM.getDetachedDomNodes",
            params=params,
            session_id=session_id,
        ))

    def setInspectedNode(
        self,
...
$x functions)."""
    ...
    def setNodeName(
        ...
        return cast("SetNodeNameReturns", self._client.send_raw(
    ...
    def getFrameOwner(
        ...
        return cast("GetFrameOwnerReturns", self._client.send_raw(
            method="DOM.getFrameOwner",
            params=params,
            session_id=session_id,
        ))

    def getContainerForNode(
        self,
...
element with a matching container-name."""
        return cast("GetContainerForNodeReturns", self._client.send_raw(
            method="DOM.getContainerForNode",
            params=params,
            session_id=session_id,
        ))

    def getQueryingDescendantsForContainer(
        self,
...
container queries against this container."""
        return cast("GetQueryingDescendantsForContainerReturns", self._client.send_raw(
            method="DOM.getQueryingDescendantsForContainer",
            params=params,
            session_id=session_id,
        ))

    def getAnchorElement(
        self,
...
https://www.w3.org/TR/css-anchor-position-1/#target."""
        return cast("GetAnchorElementReturns", self._client.send_raw(
