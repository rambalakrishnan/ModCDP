...
position specified by `location`."""
        return cast("AddRuleReturns", self._client.send_raw(
            method="CSS.addRule",
            params=params,
    ...
    def collectClassNames(
        ...
        return cast("CollectClassNamesReturns", self._client.send_raw(
    ...
    def createStyleSheet(
        ...
        return cast("CreateStyleSheetReturns", self._client.send_raw(
...
the browser."""
    ...
    def getBackgroundColors(
        ...
        return cast("GetBackgroundColorsReturns", self._client.send_raw(
            method="CSS.getBackgroundColors",
            params=params,
            session_id=session_id,
        ))

    def getComputedStyleForNode(
        self,
        params: "GetComputedStyleForNodeParameters",
        session_id: Optional[str] = None,
    ) -> "GetComputedStyleForNodeReturns":
        """Returns the computed style for a DOM node identified by `nodeId`."""
        return cast("GetComputedStyleForNodeReturns", self._client.send_raw(
...
resolved even then, return the provided value without any changes."""
        return cast("ResolveValuesReturns", self._client.send_raw(
            method="CSS.resolveValues",
            params=params,
            session_id=session_id,
        ))

    def getLonghandProperties(
        self,
        params: "GetLonghandPropertiesParameters",
        session_id: Optional[str] = None,
    ) -> "GetLonghandPropertiesReturns":
        return cast("GetLonghandPropertiesReturns", self._client.send_raw(
            method="CSS.getLonghandProperties",
            params=params,
            session_id=session_id,
        ))

    def getInlineStylesForNode(
        self,
...
attributes) for a DOM node identified by `nodeId`."""
        return cast("GetInlineStylesForNodeReturns", self._client.send_raw(
            method="CSS.getInlineStylesForNode",
            params=params,
            session_id=session_id,
        ))

    def getAnimatedStylesForNode(
        self,
...
including the animation & transition styles coming from inheritance chain."""
        return cast("GetAnimatedStylesForNodeReturns", self._client.send_raw(
            method="CSS.getAnimatedStylesForNode",
            params=params,
            session_id=session_id,
        ))

    def getMatchedStylesForNode(
        self,
        params: "GetMatchedStylesForNodeParameters",
        session_id: Optional[str] = None,
    ) -> "GetMatchedStylesForNodeReturns":
        """Returns requested styles for a DOM node identified by `nodeId`."""
        return cast("GetMatchedStylesForNodeReturns", self._client.send_raw(
    ...
    def getMediaQueries(
        ...
        return cast("GetMediaQueriesReturns", self._client.send_raw(
            method="CSS.getMediaQueries",
            params=params,
            session_id=session_id,
        ))

    def getPlatformFontsForNode(
        self,
...
node."""
        return cast("GetPlatformFontsForNodeReturns", self._client.send_raw(
            method="CSS.getPlatformFontsForNode",
            params=params,
            session_id=session_id,
        ))

    def getStyleSheetText(
        self,
        params: "GetStyleSheetTextParameters",
        session_id: Optional[str] = None,
    ) -> "GetStyleSheetTextReturns":
        """Returns the current textual content for a stylesheet."""
        return cast("GetStyleSheetTextReturns", self._client.send_raw(
            method="CSS.getStyleSheetText",
            params=params,
            session_id=session_id,
        ))

    def getLayersForNode(
        self,
...
the full layer tree for the tree scope and their ordering."""
        return cast("GetLayersForNodeReturns", self._client.send_raw(
            method="CSS.getLayersForNode",
            params=params,
            session_id=session_id,
        ))

    def getLocationForSelector(
        self,
...
returns an array of locations of the CSS selector in the style sheet."""
        return cast("GetLocationForSelectorReturns", self._client.send_raw(
            method="CSS.getLocationForSelector",
            params=params,
            session_id=session_id,
        ))

    def trackComputedStyleUpdatesForNode(
        self,
...
to the front-end, no updates will be issued for the node."""
    ...
    def takeComputedStyleUpdates(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "TakeComputedStyleUpdatesReturns":
        """Polls the next batch of computed style updates."""
        return cast("TakeComputedStyleUpdatesReturns", self._client.send_raw(
...
property"""
    ...
    def setPropertyRulePropertyName(
        self,
        params: "SetPropertyRulePropertyNameParameters",
        session_id: Optional[str] = None,
    ) -> "SetPropertyRulePropertyNameReturns":
        """Modifies the property rule property name."""
        return cast("SetPropertyRulePropertyNameReturns", self._client.send_raw(
    ...
    def setKeyframeKey(
        ...
        return cast("SetKeyframeKeyReturns", self._client.send_raw(
    ...
    def setMediaText(
        ...
        return cast("SetMediaTextReturns", self._client.send_raw(
            method="CSS.setMediaText",
            params=params,
            session_id=session_id,
        ))

    def setContainerQueryText(
        self,
        params: "SetContainerQueryTextParameters",
        session_id: Optional[str] = None,
    ) -> "SetContainerQueryTextReturns":
        """Modifies the expression of a container query."""
        return cast("SetContainerQueryTextReturns", self._client.send_raw(
    ...
    def setSupportsText(
        ...
        return cast("SetSupportsTextReturns", self._client.send_raw(
    ...
    def setScopeText(
        ...
        return cast("SetScopeTextReturns", self._client.send_raw(
    ...
    def setRuleSelector(
        ...
        """Modifies the rule selector."""
        return cast("SetRuleSelectorReturns", self._client.send_raw(
    ...
    def setStyleSheetText(
        ...
        return cast("SetStyleSheetTextReturns", self._client.send_raw(
    ...
    def setStyleTexts(
        ...
        return cast("SetStyleTextsReturns", self._client.send_raw(
            method="CSS.setStyleTexts",
            params=params,
            session_id=session_id,
        ))

    def startRuleUsageTracking(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "Dict[str, Any]":
...
`takeCoverageDelta` (or since start of coverage instrumentation)."""
        return cast("StopRuleUsageTrackingReturns", self._client.send_raw(
            method="CSS.stopRuleUsageTracking",
            params=params,
            session_id=session_id,
        ))

    def takeCoverageDelta(
        self,
        params: None = None,
        session_id: Optional[str] = None,
...
instrumentation)."""
        return cast("TakeCoverageDeltaReturns", self._client.send_raw(
            method="CSS.takeCoverageDelta",
            params=params,
            session_id=session_id,
        ))

    def setLocalFontsEnabled(
        self,
