...
class CacheStorageClient:
    ...
    def requestCacheNames(
        self,
        params: Optional["RequestCacheNamesParameters"] = None,
        session_id: Optional[str] = None,
    ) -> "RequestCacheNamesReturns":
        """Requests cache names."""
        return cast("RequestCacheNamesReturns", self._client.send_raw(
    ...
    def requestCachedResponse(
        ...
        """Fetches cache entry."""
        return cast("RequestCachedResponseReturns", self._client.send_raw(
    ...
    def requestEntries(
        ...
        return cast("RequestEntriesReturns", self._client.send_raw(
