...
enabled until the result for this command is received."""
        return cast("EnableReturns", self._client.send_raw(
    ...
    def evaluateOnCallFrame(
        ...
        return cast("EvaluateOnCallFrameReturns", self._client.send_raw(
...
the same."""
        return cast("GetPossibleBreakpointsReturns", self._client.send_raw(
    ...
    def getScriptSource(
        ...
        return cast("GetScriptSourceReturns", self._client.send_raw(
            method="Debugger.getScriptSource",
            params=params,
            session_id=session_id,
        ))

    def disassembleWasmModule(
        self,
        params: "DisassembleWasmModuleParameters",
        session_id: Optional[str] = None,
    ) -> "DisassembleWasmModuleReturns":
        return cast("DisassembleWasmModuleReturns", self._client.send_raw(
            method="Debugger.disassembleWasmModule",
            params=params,
            session_id=session_id,
        ))

    def nextWasmDisassemblyChunk(
        self,
...
will return errors."""
        return cast("NextWasmDisassemblyChunkReturns", self._client.send_raw(
    ...
    def getWasmBytecode(
        ...
        return cast("GetWasmBytecodeReturns", self._client.send_raw(
    ...
    def getStackTrace(
        ...
        return cast("GetStackTraceReturns", self._client.send_raw(
...
once V8 pauses at the beginning of the restarted function."""
        return cast("RestartFrameReturns", self._client.send_raw(
    ...
    def searchInContent(
        ...
        return cast("SearchInContentReturns", self._client.send_raw(
    ...
    def setBlackboxExecutionContexts(
        self,
...
blackboxed. Array should be sorted."""
    ...
    def setBreakpoint(
        ...
        return cast("SetBreakpointReturns", self._client.send_raw(
    ...
    def setInstrumentationBreakpoint(
        ...
        return cast("SetInstrumentationBreakpointReturns", self._client.send_raw(
...
`breakpointResolved` events issued. This logical breakpoint will survive page reloads."""
        return cast("SetBreakpointByUrlReturns", self._client.send_raw(
...
calling it will also trigger the breakpoint."""
        return cast("SetBreakpointOnFunctionCallReturns", self._client.send_raw(
...
top-most function is automatically triggered."""
        return cast("SetScriptSourceReturns", self._client.send_raw(
