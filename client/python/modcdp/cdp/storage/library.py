...
class StorageClient:
    ...
    def getStorageKeyForFrame(
        self,
        params: "GetStorageKeyForFrameParameters",
        session_id: Optional[str] = None,
    ) -> "GetStorageKeyForFrameReturns":
        """Returns a storage key given a frame id."""
        return cast("GetStorageKeyForFrameReturns", self._client.send_raw(
    ...
    def getCookies(
        ...
        return cast("GetCookiesReturns", self._client.send_raw(
    ...
    def getUsageAndQuota(
        ...
        return cast("GetUsageAndQuotaReturns", self._client.send_raw(
            method="Storage.getUsageAndQuota",
            params=params,
            session_id=session_id,
        ))

    def overrideQuotaForOrigin(
        self,
    ...
    def trackCacheStorageForOrigin(
        self,
    ...
    def trackCacheStorageForStorageKey(
        self,
    ...
    def trackIndexedDBForStorageKey(
        self,
    ...
    def untrackCacheStorageForOrigin(
        self,
    ...
    def untrackCacheStorageForStorageKey(
        self,
    ...
    def untrackIndexedDBForStorageKey(
        self,
...
current browsing context."""
        return cast("GetTrustTokensReturns", self._client.send_raw(
            method="Storage.getTrustTokens",
            params=params,
            session_id=session_id,
        ))

    def clearTrustTokens(
        self,
...
Leaves other stored data, including the issuer's Redemption Records, intact."""
        return cast("ClearTrustTokensReturns", self._client.send_raw(
            method="Storage.clearTrustTokens",
            params=params,
            session_id=session_id,
        ))

    def getInterestGroupDetails(
        self,
        params: "GetInterestGroupDetailsParameters",
        session_id: Optional[str] = None,
    ) -> "GetInterestGroupDetailsReturns":
        """Gets details for a named interest group."""
        return cast("GetInterestGroupDetailsReturns", self._client.send_raw(
            method="Storage.getInterestGroupDetails",
            params=params,
            session_id=session_id,
        ))

    def setInterestGroupTracking(
        self,
    ...
    def setInterestGroupAuctionTracking(
        self,
...
interestGroupAuctionNetworkRequestCreated."""
    ...
    def runBounceTrackingMitigations(
        self,
        params: None = None,
        session_id: Optional[str] = None,
    ) -> "RunBounceTrackingMitigationsReturns":
        """Deletes state for sites identified as potential bounce trackers, immediately."""
        return cast("RunBounceTrackingMitigationsReturns", self._client.send_raw(
            method="Storage.runBounceTrackingMitigations",
            params=params,
            session_id=session_id,
        ))

    def setAttributionReportingLocalTestingMode(
        self,
    ...
    def setAttributionReportingTracking(
        self,
    ...
    def sendPendingAttributionReports(
        self,
        params: None = None,
        session_id: Optional[str] = None,
...
scheduled report time."""
        return cast("SendPendingAttributionReportsReturns", self._client.send_raw(
            method="Storage.sendPendingAttributionReports",
            params=params,
            session_id=session_id,
        ))

    def getRelatedWebsiteSets(
        self,
        params: None = None,
        session_id: Optional[str] = None,
...
session. The effective Related Website Sets will not change during a browser session."""
        return cast("GetRelatedWebsiteSetsReturns", self._client.send_raw(
            method="Storage.getRelatedWebsiteSets",
            params=params,
            session_id=session_id,
        ))

    def getAffectedUrlsForThirdPartyCookieMetadata(
        self,
...
https://developers.google.com/privacy-sandbox/cookies/temporary-exceptions/grace-period"""
        return cast("GetAffectedUrlsForThirdPartyCookieMetadataReturns", self._client.send_raw(
            method="Storage.getAffectedUrlsForThirdPartyCookieMetadata",
            params=params,
            session_id=session_id,
        ))

    def setProtectedAudienceKAnonymity(
        self,
