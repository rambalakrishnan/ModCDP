...
Backend then generates 'inspectNodeRequested' event upon element selection."""
    ...
    def setShowContainerQueryOverlays(
        self,
    ...
    def setShowWindowControlsOverlay(
        self,
