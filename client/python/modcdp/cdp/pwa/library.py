...
class PWAClient:
    ...
    def getOsAppState(
        ...
        return cast("GetOsAppStateReturns", self._client.send_raw(
...
can be used to attach to via Target.attachToTarget or similar APIs."""
        return cast("LaunchReturns", self._client.send_raw(
            method="PWA.launch",
            params=params,
            session_id=session_id,
        ))

    def launchFilesInApp(
        self,
...
TODO(crbug.com/339454034): Check the existences of the input files."""
        return cast("LaunchFilesInAppReturns", self._client.send_raw(
            method="PWA.launchFilesInApp",
            params=params,
            session_id=session_id,
        ))

    def openCurrentPageInApp(
        self,
